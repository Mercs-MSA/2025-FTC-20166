...
module TurretMountPlate()
{
  ...
  WidthModifier = NarrowTurretMountPlate ? 32/25.4 : 0;
  ...
  difference()
  {
    hull()
    {
      ...
      translate([-(RobotOuterWidth / 2) + WidthModifier, 0, 0])
        cube([.001, 3, ShooterPlateT], center = true);
      translate([(RobotOuterWidth / 2) - WidthModifier, 0, 0])
        cube([.001, 3, ShooterPlateT], center = true);
    }
